...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	<%--分页显示的开始 --%>
    	<div style="text-align:center">
    		...
    		<!-- store_v5_zywGH/ProdoctServlet?method=findProductsByidWithPage&cid=1&num=1
    		由于在分页信息页面下 点击其他分页 相当于重新查询其他页面信息，再次调用该方法
    		因此 url=ProdoctServlet?method=findProductsByidWithPage&cid= -->
